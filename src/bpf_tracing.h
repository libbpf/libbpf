...
/* If kernel doesn't have CONFIG_ARCH_HAS_SYSCALL_WRAPPER, read pt_regs directly */
...
/* If kernel has CONFIG_ARCH_HAS_SYSCALL_WRAPPER, we have to BPF_CORE_READ from pt_regs */
